...
const h2_presale_coming_soon = "countdown to origine arrival";
const h2_presale_mint = "countdown to metaGardien arrival";
const p_presale_coming_soon = "the protectors of the metaverse are on their way";
const p_presale_mint_not_whitelisted = "you do not have access to the presale";
const p_presale_mint_whitelisted = "you have access to the presale";
const p_presale_mint_already_minted = "you have already claimed your presale mint";
const p_public_mint = "public minting is now open";
const button_presale_coming_soon = "gain access to presale";
const button_presale_mint_whitelisted = "mint your origine";
const button_presale_mint_not_whitelisted = "join the whitelist for access";
const button_presale_already_minted = "join the protected ones";
const button_public_mint = "mint your metaGardien";
